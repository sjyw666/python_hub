...
def main():
    ...
    # 只要把layout传递给window函数就可以让窗口搭载设定好的控件了
...
if __name__ == '__main__':
    background_image = ('https://img-nos.yiyouliao.com/inforec-20230301-cca2fb320e185e8a603aba813e1825c6.jpg?yiyouliao_channel=xiaomi_image')
